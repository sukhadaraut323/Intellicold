...
df_kaggle    = load_excel(r'C:\Users\HP\IntelliCold\backend\ml_model\datasets\KAGGLE.xlsx',    'Sensor_Log')
...
# ── ACM datasets ─────────────────────────────────────────────────────────────
df_acm_full  = load_excel(r'C:\Users\HP\IntelliCold\backend\ml_model\datasets\ACM_TRAIN.xlsx', 'intellicold_full_1000_rows.csv')
df_acm_train = load_excel(r'C:\Users\HP\IntelliCold\backend\ml_model\datasets\ACM_MAIN.xlsx',  'intellicold_train_800_rows.csv')
df_acm_test  = load_excel(r'C:\Users\HP\IntelliCold\backend\ml_model\datasets\ACM_ML.xlsx',    'intellicold_test_200_rows.csv')
